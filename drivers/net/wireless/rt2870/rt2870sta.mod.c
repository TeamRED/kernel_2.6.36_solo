...
"depends=crc-ccitt,firmware_class";
...
MODULE_ALIAS("usb:v2001p3C09d*dc*dsc*dp*ic*isc*ip*");
MODULE_ALIAS("usb:v2001p3C0Ad*dc*dsc*dp*ic*isc*ip*");
MODULE_ALIAS("usb:v2019pED14d*dc*dsc*dp*ic*isc*ip*");

MODULE_INFO(srcversion, "93E93E3E336F412601AF0FA");
